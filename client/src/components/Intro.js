    ...
    render() { 
        return ( 
            <div className="App-intro">
                <h1 style = {this.props.weather.includes("clear") || this.props.weather.includes("rain") || this.props.weather.includes("cloud") ? {color:"white"} : {color: "green"}}>It looks like it's {this.getText()}</h1>
